...
def Log_In():
	...
	Lac(W+20 * '\xE2\x95\x90\xE2\x95\x90')
	print
	Lac(C+'Log In \Username & Password\nOwner    : '+W+'Lac'+C+'\nWhatsApp : '+W+'01723420764')
	print
	Lac(W+20 * '\xE2\x95\x90\xE2\x95\x90')
	username = 'lac'
	password = 'lac'
...
def labibhacker():
	os.system('clear')
	print(W+'   ['+H+'\xE2\x9C\x9A'+W+'] Welcome Lac Tool'+W+'['+H+'\xE2\x9C\x9A'+W+']')
	Lac(W+20 * '\xE2\x95\x90\xE2\x95\x90')
	print
        print(W+'['+H+'1'+W+']'+C+' Start Instagram Hacking')
	print(W+'['+H+'2'+W+']'+C+' Subscribe Channel Lac')
	...
	if Choose == 1:
		...
		print
		Lac(C+'YouTube Channel Lac'+W+' ...')
		time.sleep(1.5)
		os.system('xdg-open https://m.youtube.com/channel/UCRrRgcJjsnNm5Bi5ZenRGhg')
		labibhacker()
	
	elif Choose == 3:
		print
		LAC(C+'WhatsApp Group'+W+' ...')
		time.sleep(1.5)
		os.system('xdg-open https://chat.whatsapp.com/FmuKakzK8oV3Rp6gpfhgfd')
		labibhacker()
